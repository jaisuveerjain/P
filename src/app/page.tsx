...
const content: contentSection[] = [
  {
    ...
    sectionHeader: {
      ...
      description: (
        <div>
          <span className="text-work_experience_orange">Semi-Senior Software Engineer </span> with <span className="text-work_experience_orange">3 years</span> of experience in the software industry
        </div>
      ),
    },
          ...
          <div className="min-h-screen relative">
            <FadeIn className="max-w-5xl pt-40 md:pt-[20vh] 2xl:pt-[30vh]">
              <h1 className="font-display text-5xl font-medium tracking-tight [text-wrap:balance] sm:text-6xl">
                Jai Suveer Jain<span className="wave">👋</span>
              </h1>
              ...
              <br></br>
              <p className="text-base leading-7 text-about_me_green"><b>Work Experience</b></p>
              <p className="max-w-3xl"><b>Freelancer</b>: Full Stack Web Development for Portfolio Creations -
                Berlin, Germany.</p>
              <p className="max-w-3xl"><b>Application Developer</b>: Tecnotree Convergence Private Limited (MTN) -
                Lagos, Nigeria.</p>
              <p className="max-w-3xl"><b>Software Engineer</b>: Tecnotree Convergence Private Limited - Bangalore,
                India.</p>

              <br></br>
              <p className="text-base leading-7 text-about_me_green"><b>Education</b></p>
                <p className="max-w-3xl"><b>Masters in Data Analytics</b>: University for the Creative Arts - Berlin,
                  Germany.</p>
                <p className="max-w-3xl"><b>Bachelors in Information Science and Engineering</b>: Malnad College of
                  Engineering - Hassan, India.</p>
